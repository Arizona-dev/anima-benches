...
> Honcho's `89.9%` comes from its public site, and Backboard's `90.0%` comes
> from its public LoCoMo benchmark repository.
...
> rather than a binary-accuracy figure, so this comparison should be treated as
